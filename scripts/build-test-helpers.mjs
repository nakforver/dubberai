...
fs.writeFileSync(
  ...
  source.slice(0, endpointIndex) +
    '\nexport { parseTimestamp, buildRenderedAudioSegments, validateSegmentTimeline, escapeFFmpegFilterPath, buildSubtitleVideoFilter, buildAssVideoFilter, convertSrtToAss, validateSubtitleLines, mergeTranslatedSubtitleLine, validateExportAudioMetadata, buildFinalAudioMap, normalizeSubtitleTimeline, cleanJsonResponse, callOpenAiCompatibleChat, translateSubtitleLinesWithAI };\n'
);
