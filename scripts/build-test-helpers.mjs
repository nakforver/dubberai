...
fs.writeFileSync(
  ...
  source.slice(0, endpointIndex) +
    '\nexport { parseTimestamp, buildRenderedAudioSegments, validateSegmentTimeline, escapeFFmpegFilterPath, buildSubtitleVideoFilter, validateSubtitleLines, mergeTranslatedSubtitleLine, validateExportAudioMetadata, buildFinalAudioMap, normalizeSubtitleTimeline };\n'
);
