...
function convertSrtToAss(srtContent: string, width = 1280, height = 720): string {
  ...
  const fontSize = isPortrait ? 26 : 28;
  const marginV = isPortrait ? 60 : 35;
  const marginLR = isPortrait ? 30 : 40;
...
Style: Default,Noto Sans Khmer,${fontSize},&H00FFFFFF,&H000000FF,&H00000000,&H80000000,1,0,0,0,100,100,0,0,1,2.2,0.8,2,${marginLR},${marginLR},${marginV},1
